...
macro(ceammc_add_test title name)
    ...
    if(${CMAKE_CXX_COMPILER_ID} STREQUAL GNU)
      set(_NUMERIC_LITERALS "-fext-numeric-literals")
    endif()
    if(UNIX)
      # set_target_properties(${name} PROPERTIES COMPILE_FLAGS ${_NUMERIC_LITERALS})
      # set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} ${_NUMERIC_LITERALS}")
      add_definitions(${_NUMERIC_LITERALS})
